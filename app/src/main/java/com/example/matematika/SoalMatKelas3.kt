...
class SoalMatKelas3 : Fragment() {
    ...
    private val soalMatsd3: List<List<Pair<String, Int>>> = listOf(
        listOf(
            Pair("1. Sudut yang besarnya adalah dinamakan sudut ...", R.mipmap.soal_mat_pat_kelas3_soal1),
        ...
        listOf(Pair("25. Sebuah buku yang panjangnya 30 cm dan lebarnya 20 m, luasnya adalah...", 0),
            Pair("26. Gambar di bawah ini memiliki sudut tumpul sebanyak...", R.mipmap.soal_mat_pat_kelas3_soalb4),
            Pair("27. Luas persegi panjang dibawah ini adalah...", R.mipmap.soal_mat_pat_kelas3_soalb8)),

        listOf(Pair("28.    Pak Joko mempunyai sawah berbentuk persegi panjang. Panjangnya 100 m dan lebarnnya 50 m. Pak Joko ingin membuatkan pagar jaring untuk menglilingi sawahnya. Berapakah panjang jaring yang dibutuhkan Pak Joko?", 0),
            Pair("29.	Andi memliki kolam renang berbentuk persegi. Panjang setiap sisinya adalah 18 m. Berapakah luas kolam milik Andi?", 0),
    ...
    private  val pilihanGanda3: List<List<List<String>>> = listOf(
        ...
        listOf(
            ...
            listOf("a. 70m dan 6m","b. 19m dan 4m","c. 7m dan 6m","d. 9m x 8m"),
            listOf("a. 114m","b. 171m","c. 128m","d. 228 m")
        ),
        listOf(
